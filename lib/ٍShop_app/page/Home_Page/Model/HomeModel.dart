class ModelHome {
  bool? status;
  ModelDataHome? dataHome;
  ModelHome();
  ModelHome.fronJson({Map<String, dynamic>? json}) {
    status = json!['status'];
    dataHome = json['data'] != null
        ? ModelDataHome.fromJson(json: json['data'])
        : null;
  }
}
...
class ModelDataHome {
  ...
  ModelDataHome.fromJson({Map<String, dynamic>? json}) {
    json!['banners'].forEach((element) {
      banners.add(Banners.fromJson(json: element));
    });
    json['products'].forEach((element) {
      products.add(Products.fromJson(json: element));
    });
  }
}
...
//             {
//                 "id": 12,
//                 "image": "https://student.valuxapps.com/storage/uploads/banners/1619472116OYHxC.45b7de97376281.5ec3ca8c1d324.jpg",
//                 "category": null,
//                 "product": null
//             },
//             {
//                 "id": 17,
//                 "image": "https://student.valuxapps.com/storage/uploads/banners/1626544896muQ0Q.best-deal-promotional-ribbon-style-green-banner-design_1017-27469.jpg",
//                 "category": null,
//                 "product": null
//             },
//             {
...
//             {
//                 "id": 23,
//                 "image": "https://student.valuxapps.com/storage/uploads/banners/16283378549Vinn.banner foods@2x.png",
//                 "category": null,
//                 "product": null
//             },
//             {
//                 "id": 24,
//                 "image": "https://student.valuxapps.com/storage/uploads/banners/1641000123OrbOP.BALCK-White-FRIDAY-AR21112019.jpg",
//                 "category": null,
//                 "product": null
//             },
//             {
//                 "id": 25,
//                 "image": "https://student.valuxapps.com/storage/uploads/banners/1641000140NnSq9.black-friday-cyber-monday-sales.jpg",
//                 "category": null,
//                 "product": null
//             },
//             {
//                 "id": 26,
//                 "image": "https://student.valuxapps.com/storage/uploads/banners/1641000163w2k1O.انطلاق-عروض-الجمعة-السوداء-Black-Friday-على-متجر-TomTop.jpg",
//                 "category": null,
//                 "product": null
//             },
//             {
//                 "id": 27,
//                 "image": "https://student.valuxapps.com/storage/uploads/banners/1648845777FC4nO.IMG-20220324-WA0010.jpg",
//                 "category": {
//                     "id": 42,
...
//             }
//         ],
//         "ad": "https://student.valuxapps.com/storage/uploads/banners/1648845777FC4nO.IMG-20220324-WA0010.jpg"
//     }
// }ؤمشسس
